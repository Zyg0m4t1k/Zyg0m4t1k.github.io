...
:::caution Points importants avant de faire la mise à jour vers la version 2
...
| Luminosité | Info | Niveau de luminosité actuel (%) |
| Régler luminosité | Action | Définit la luminosité (1–100) |
| Couleur | Info | Couleur actuelle (format HEX `#RRGGBB`) |
| Régler couleur | Action | Définit la couleur (RGB / HEX) |
| Température de couleur | Info | Température actuelle (Kelvin) |
| Régler température | Action | Définit la température de couleur |
| Mode couleur | Info | Mode actif (couleur ou blanc) |
| Effet | Info | Effet lumineux actif |
| Régler effet | Action | Active un effet prédéfini |

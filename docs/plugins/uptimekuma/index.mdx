...
{/* ![Installation du plugin depuis le Market](/img/plugins/uptimekuma/install_market.png) */}
{/* Screenshot : page Market avec le plugin Uptime Kuma visible, bouton "Installer stable" */}
...
{/* ![Dependances OK](/img/plugins/uptimekuma/dependances_ok.png) */}
{/* Screenshot : page configuration du plugin, section dependances avec statut OK en vert */}
...
{/* ![Configuration demon](/img/plugins/uptimekuma/config_demon.png) */}
{/* Screenshot : page configuration du plugin, section demon avec port socket, cycle, et statut OK */}
...
{/* ![Configuration source](/img/plugins/uptimekuma/config_source.png) */}
{/* Screenshot : onglet equipement d'une source, avec les champs URL, identifiant, mot de passe remplis */}

5. Cliquer **Tester la connexion** pour valider

{/* ![Test connexion OK](/img/plugins/uptimekuma/test_connexion.png) */}
{/* Screenshot : message de succes apres test de connexion, avec le nombre de moniteurs detectes */}
...
{/* ![Decouverte moniteurs](/img/plugins/uptimekuma/decouverte_moniteurs.png) */}
{/* Screenshot : modal de decouverte avec la liste des moniteurs detectes (nom, type, URL/hostname) */}

{/* ![Synchronisation terminee](/img/plugins/uptimekuma/sync_terminee.png) */}
{/* Screenshot : message de succes apres synchronisation, avec le nombre de moniteurs crees/mis a jour */}
...
| **last_sync** | info string | Date/heure de la derniere synchronisation |
...
{/* Screenshot : widget d'un moniteur en etat UP — fond vert, ping affiche, bouton webhook visible */}

{/* ![Widget moniteur DOWN](/img/plugins/uptimekuma/widget_monitor_down.png) */}
{/* Screenshot : widget d'un moniteur en etat DOWN — fond rouge, message d'erreur affiche */}
...
{/* Screenshot : widget source avec l'icone connexion verte, le total de moniteurs, et les 5 lignes de repartition par statut */}
...
{/* Screenshot : panel complet avec cartes de synthese en haut, section problemes au milieu, et tableau des moniteurs en bas */}
...
{/* ![Section problemes](/img/plugins/uptimekuma/panel_problemes.png) */}
{/* Screenshot : section "Problemes" affichant 2-3 moniteurs DOWN ou UNAVAILABLE avec leurs details */}
...
{/* ![Filtres panel](/img/plugins/uptimekuma/panel_filtres.png) */}
{/* Screenshot : barre de filtres avec boutons de statut actifs, dropdown source, dropdown tag, et champ de recherche */}
...
{/* ![Tableau moniteurs](/img/plugins/uptimekuma/panel_tableau.png) */}
{/* Screenshot : tableau avec 5-10 moniteurs affichant toutes les colonnes, certains UP, certains DOWN */}
...
{/* Screenshot : panel mobile sur smartphone avec la liste des moniteurs et leurs statuts colores */}
...
{/* ![Bouton Support Forum](/img/plugins/uptimekuma/bouton_support.png) */}
{/* Screenshot : barre de boutons en haut de la page plugin, avec le bouton "Support Forum" (icone bouee bleue) visible */}

...
- Intégration du script `dependance.lib` pour la gestion des dépendances Python
- Vérification automatique de la version de Python requise
- Support de **Python ≥ 3.11** (requis par python-matter-server)
- Meilleure compatibilité avec :
  - Debian 12 (recommandé)
  - Debian 13 (supporté)
  - Debian 11 (fonctionnel si Python 3.11 installé)

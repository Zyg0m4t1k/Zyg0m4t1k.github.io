...
Le plugin **tailscale** connecte Jeedom au réseau [Tailscale](https://tailscale.com), un VPN mesh basé sur WireGuard. Accédez à Jeedom depuis n'importe quel appareil de votre tailnet, sans ouvrir de port ni configurer de routeur.
...
<Tabs>
<TabItem value="access" label="Accès distant" default>

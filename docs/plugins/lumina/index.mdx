...
<PluginHero
  ...
  badges={["Jeedom 4.4+", "stable", "php 7.4/8.x"]}
...
<!-- screenshot: formulaire de création d'un équipement Lumina avec le champ Nom -->
<!-- path: /img/plugins/lumina/equipment_new.png -->
<!-- ![Création d'un nouvel équipement Lumina](/img/plugins/lumina/equipment_new.png) -->
...
| **Configuration** | Actionneurs, lux, lampes et périodes horaires |
...
<!-- screenshot: section Actionneurs avec un détecteur de présence ajouté -->
<!-- path: /img/plugins/lumina/actuators.png -->
...
<!-- screenshot: champ commande lux avec le sélecteur de commande -->
<!-- path: /img/plugins/lumina/lux_cmd.png -->
<!-- ![Sélection de la commande lux](/img/plugins/lumina/lux_cmd.png) -->
...
<!-- screenshot: section Lampes vide avec le bouton + pour ajouter -->
<!-- path: /img/plugins/lumina/lamps_empty.png -->
<!-- ![Section Lampes vide avant ajout](/img/plugins/lumina/lamps_empty.png) -->

<!-- screenshot: modal d'ajout automatique d'une lampe depuis un équipement Jeedom existant -->
<!-- path: /img/plugins/lumina/lamps_auto_add.png -->
<!-- ![Ajout automatique d'une lampe depuis un équipement Jeedom](/img/plugins/lumina/lamps_auto_add.png) -->

<!-- screenshot: lampe correctement configurée avec On Off couleur température et niveau détectés -->
<!-- path: /img/plugins/lumina/lamps_detected.png -->
<!-- ![Lampe avec toutes ses commandes détectées automatiquement](/img/plugins/lumina/lamps_detected.png) -->
...
<!-- screenshot: configuration de la couleur sur une lampe avec le sélecteur de couleur -->
<!-- path: /img/plugins/lumina/lamp_color.png -->
<!-- ![Configuration de la couleur pour une lampe](/img/plugins/lumina/lamp_color.png) -->

<!-- screenshot: configuration de la température de couleur avec le slider Kelvin -->
<!-- path: /img/plugins/lumina/lamp_temperature.png -->
<!-- ![Configuration de la température de couleur](/img/plugins/lumina/lamp_temperature.png) -->

<!-- screenshot: configuration du niveau d'intensité avec le slider pourcentage -->
<!-- path: /img/plugins/lumina/lamp_level.png -->
<!-- ![Configuration du niveau d'intensité (%)](/img/plugins/lumina/lamp_level.png) -->
...
<!-- screenshot: liste des périodes configurées avec leurs onglets matin soirée nuit -->
<!-- path: /img/plugins/lumina/periods_list.png -->
<!-- ![Liste des périodes de la journée](/img/plugins/lumina/periods_list.png) -->

<!-- screenshot: édition d'une période avec les champs début fin durée seuil lux et actions -->
<!-- path: /img/plugins/lumina/period_edit.png -->
<!-- ![Édition d'une période horaire](/img/plugins/lumina/period_edit.png) -->
...
<!-- screenshot: champs latitude longitude avec le bouton Générer Lever Coucher -->
<!-- path: /img/plugins/lumina/sun_periods.png -->
<!-- ![Génération automatique des périodes solaires](/img/plugins/lumina/sun_periods.png) -->
...
<!-- screenshot: widget dashboard montrant le mode OFF actif avec le point rouge -->
<!-- path: /img/plugins/lumina/mode_off.png -->
<!-- ![Mode OFF actif sur le widget](/img/plugins/lumina/mode_off.png) -->
...
<!-- screenshot: onglet Ambiances avec plusieurs ambiances listées -->
<!-- path: /img/plugins/lumina/ambiances_section.png -->
<!-- ![Section Ambiances avec la liste des ambiances configurées](/img/plugins/lumina/ambiances_section.png) -->

<!-- screenshot: édition d'une ambiance avec ses lampes et ses couleurs -->
<!-- path: /img/plugins/lumina/ambiance_edit.png -->
<!-- ![Édition d'une ambiance lumineuse](/img/plugins/lumina/ambiance_edit.png) -->
...
<!-- screenshot: widget Lumina sur le dashboard avec le badge mode et les boutons Armer Désarmer -->
<!-- path: /img/plugins/lumina/widget_dashboard.png -->
<!-- ![Widget Lumina sur le dashboard Jeedom](/img/plugins/lumina/widget_dashboard.png) -->

<!-- screenshot: widget Lumina sur la vue mobile -->
<!-- path: /img/plugins/lumina/widget_mobile.png -->

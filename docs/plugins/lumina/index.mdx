...
- le **mode Suspendu** pour éteindre et geler l'automatisme jusqu'au départ de tous les occupants
...
Le **mode Suspendu** permet d'éteindre les lumières et de geler toute automatisation jusqu'à ce que la pièce soit vide, puis de reprendre automatiquement.

Quand la commande `Suspendre` est exécutée :

1. Les lumières sont **éteintes immédiatement**
2. Lumina **bloque les actionneurs** (aucun allumage automatique)
3. Lumina **surveille les détecteurs de présence** en continu
4. Dès que **tous les détecteurs sont à 0** (pièce vide), Lumina repasse automatiquement en **mode Auto**

Ce mode est particulièrement utile pour :

- Forcer l'extinction quand quelqu'un a allumé manuellement et que vous voulez repartir sur une base propre
- Éteindre et attendre que tout le monde soit sorti avant de reprendre l'automatisme
- Éviter de perturber quelqu'un encore présent tout en préparant l'extinction finale

:::info Différence avec le mode OFF
Le **mode OFF** bloque l'automatisme indéfiniment (jusqu'à désactivation manuelle).
Le **mode Suspendu** se lève automatiquement quand la pièce se vide — sans intervention.
:::

Il est activé via la commande `Suspendre`.
...
| `État suspendu` | info binaire | 1 = mode Suspendu actif |
...
| `Suspendre` | Éteint les lumières et bloque l'automatisme jusqu'à ce que tous les détecteurs soient à 0, puis reprend en mode Auto |
...
// Suspendre (éteindre et attendre que la pièce soit vide)
[Salon][Lumina][Suspendre]
```

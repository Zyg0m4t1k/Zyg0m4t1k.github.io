...
![Configuration générale](/img/plugins/whatwatt/config_plugin.png)
...
```json title="Payload MQTT WhatWatt"
{
  "P_In": ${1_7_0},
  "P_Out": ${2_7_0},
...
![Configuration Whatwatt](/img/plugins/whatwatt/config_whatwatt.png)
...
![Equipement](/img/plugins/whatwatt/equipment.png)

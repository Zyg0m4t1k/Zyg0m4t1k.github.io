...
- [Procédure d’authentification](#procedure-authentification)
- [Types d’équipements](#types-equipements)
- [Paramètres importants](#parametres-importants)
- [Utilisation en scénario](#utilisation-scenario)
...
<span id="procedure-authentification" />

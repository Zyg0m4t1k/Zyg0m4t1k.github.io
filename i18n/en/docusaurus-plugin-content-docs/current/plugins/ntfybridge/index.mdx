...
## 🖥️ Configure the ntfy Server {#configure-the-ntfy-server}
...
## 👥 Manage Users (Panel) {#manage-users-panel}
...
## 📱 Install and Configure the ntfy App {#install-and-configure-the-ntfy-app}
...
## 🌐 Configure the Reverse Proxy (Embedded Mode + Subdomain) {#reverse-proxy}
